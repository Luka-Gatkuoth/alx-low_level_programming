...
/**
 * linear_skips - searche for the value conatined in a skip list; assumes a
 * list with sorted values and a single skip layer with nodes at every index
 * which is a multiple of the square root of size of the list
 *
 * @list: pointer to the head of the skip list to the traverse
